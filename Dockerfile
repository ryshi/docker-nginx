...
RUN wget -O /tmp/nginx-1.12.2.tar.gz http://nginx.org/download/nginx-1.12.2.tar.gz
RUN wget -O /tmp/LuaJIT-2.0.3.tar.gz http://luajit.org/download/LuaJIT-2.0.3.tar.gz
RUN wget -O /tmp/lua-nginx-module-0.10.13.zip https://github.com/openresty/lua-nginx-module/archive/v0.10.13.zip
